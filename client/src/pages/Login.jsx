                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={""}>
                            <div>
                                ...
                                <input type="text" name="uname" id="uname" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required=""/>
                            </div>
                            <div>
                            ...
                            <button type="submit" className="w-full bg-gradient-to-r from-orange-500 to-red-600 via-red-700 via-purple-800 text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign in</button>
